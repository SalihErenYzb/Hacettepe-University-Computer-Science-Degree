...
public class MolecularStructure {
    ...
    public MolecularStructure(MolecularStructure structure) {
    ...
    public boolean equals(Object obj) {
        ...
        ArrayList<Molecule> sortedMoleculesOther = new ArrayList<>(other.molecules);
        Collections.sort(sortedMoleculesOther);
        return sortedMolecules.equals(sortedMoleculesOther);
    }
